...
function lighting_engine_draw_sprite(diffusemap_index, diffusemap_subimage, normalmap_texture, specularmap_texture, normalmap_uvs, specularmap_uvs, x_pos, y_pos, x_scale, y_scale, rotation, color, alpha, layer_depth_value) 
{
    //
    ...
    //
    shader_set_uniform_f(LightingEngine.mrt_deferred_lighting_dynamic_sprite_shader_layer_depth_index, layer_depth_value);
