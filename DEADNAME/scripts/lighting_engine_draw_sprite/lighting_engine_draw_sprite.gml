...
{
    //
    texture_set_stage(LightingEngine.mrt_deferred_lighting_shader_normalmap_texture_index, normalmap_texture);
    texture_set_stage(LightingEngine.mrt_deferred_lighting_shader_specularmap_texture_index, specularmap_texture);
    ...
    shader_set_uniform_f_array(LightingEngine.mrt_deferred_lighting_shader_specularmap_uv_index, specularmap_uvs);
