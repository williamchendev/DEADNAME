...
function rotation_matrix_from_euler_angles(euler_angle_x, euler_angle_y, euler_angle_z)
{
    ...
    /*
    temp_rotation_matrix[0] = temp_cy * temp_cp + temp_sy * temp_sr * temp_sp;
    temp_rotation_matrix[1] = -temp_sy * temp_cp + temp_cy * temp_sr * temp_sp;
    temp_rotation_matrix[2] = temp_cr * temp_sp;
    temp_rotation_matrix[3] = 0;
    ...
    temp_rotation_matrix[8] = -temp_cy * temp_sp + temp_cp * temp_sy * temp_sr;
    temp_rotation_matrix[9] = temp_sy * temp_sp + temp_cy * temp_sr * temp_cp;
    temp_rotation_matrix[10] = temp_cr * temp_cp;
    temp_rotation_matrix[11] = 0;
