...
// Create Sub Layer
lighting_engine_create_sub_layer(sub_layer_name == LightingEngineUseGameMakerLayerName ? layer_get_name(layer) : sub_layer_name, sub_layer_depth, LightingEngineSubLayerType.Dynamic, temp_render_layer_type);
