/// @description Planetside Revolver Init

// Inherit the parent event
event_inherited();

// Sprite Settings
weapon_sprite = sBlackMarket_PlanetsideRevolver;
weapon_normal_sprite = sBlackMarket_PlanetsideRevolver_NormalMap;
...
close_range_hit_chance = 0.8;
mid_range_hit_chance = 0.6;
far_range_hit_chance = 0.2;
