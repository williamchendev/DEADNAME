...
// Animation Settings
idle_animation = sWilliam_NorthernBrigade_Idle;
walk_animation = sWilliam_NorthernBrigade_Run;
jump_animation = sWilliam_NorthernBrigade_Jump;
aim_animation = sWilliam_NorthernBrigade_Aim;
aim_walk_animation = sWilliam_NorthernBrigade_AimWalk;

idle_normals = sWilliam_NorthernBrigade_Idle_NormalMap;
walk_normals = sWilliam_NorthernBrigade_Run_NormalMap;
jump_normals = sWilliam_NorthernBrigade_Jump_NormalMap;
aim_normals = sWilliam_NorthernBrigade_Aim_NormalMap;
aim_walk_normals = sWilliam_NorthernBrigade_AimWalk_NormalMap;
...
add_item_inventory(inventory, 15, 24);
