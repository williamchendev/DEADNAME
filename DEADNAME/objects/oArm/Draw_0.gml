...
var temp_light_surface_x_offset = 0;
var temp_light_surface_y_offset = 0;
...
if (instance_exists(oLighting)) {
	...
	temp_light_surface_x_offset = temp_lighting_manager_inst.x;
	temp_light_surface_y_offset = temp_lighting_manager_inst.y;
...
if (temp_arm_sprite_index == noone) {
	...
	draw_line_width(limb_anchor_x + temp_offset - temp_light_surface_x_offset, limb_anchor_y - temp_light_surface_y_offset, point1_x + temp_offset - temp_light_surface_x_offset, point1_y - temp_light_surface_y_offset, 2);
	draw_line_width(point1_x + temp_offset - temp_light_surface_x_offset, point1_y - temp_light_surface_y_offset, point2_x + temp_offset - temp_light_surface_x_offset, point2_y - temp_light_surface_y_offset, 2);
	
	draw_set_alpha(1);
	draw_set_color(c_red);
	draw_point(limb_anchor_x + temp_offset - temp_light_surface_x_offset, limb_anchor_y - temp_light_surface_y_offset);
