...
else
{
    ...
    {
        show_debug_message($"Debug Warning! - Unsuccessfully added Dynamic Particle System to Lighting Engine Sub Layer with name \"{sub_layer_use_default_layer ? LightingEngineDefaultLayer : temp_dynamic_particle_layer}\"");
        return;
    }
}
