...
// Animation Settings
idle_animation = sWilliam_NorthernBrigade_Soldat_Idle;
walk_animation = sWilliam_NorthernBrigade_Soldat_Run;
jump_animation = sWilliam_NorthernBrigade_Soldat_Jump;
aim_animation = sWilliam_NorthernBrigade_Soldat_Aim;
aim_walk_animation = sWilliam_NorthernBrigade_Soldat_AimWalk;

idle_normals = sWilliam_NorthernBrigade_Soldat_Idle_NormalMap;
walk_normals = sWilliam_NorthernBrigade_Soldat_Run_NormalMap;
jump_normals = sWilliam_NorthernBrigade_Soldat_Jump_NormalMap;
aim_normals = sWilliam_NorthernBrigade_Soldat_Aim_NormalMap;
aim_walk_normals = sWilliam_NorthernBrigade_Soldat_AimWalk_NormalMap;
...
add_item_inventory(inventory, 8, 24);
