...
// MRT Deferred Lighting Dynamic Sprite Alpha Filtered Shader Indexes
mrt_deferred_lighting_dynamic_sprite_alpha_filtered_shader_camera_offset_index = shader_get_uniform(shd_mrt_deferred_lighting_dynamic_sprite_alpha_filter, "in_Camera_Offset");

mrt_deferred_lighting_dynamic_sprite_alpha_filtered_shader_normalmap_uv_index = shader_get_uniform(shd_mrt_deferred_lighting_dynamic_sprite_alpha_filter, "in_Normal_UVs");
mrt_deferred_lighting_dynamic_sprite_alpha_filtered_shader_metallicroughnessmap_uv_index = shader_get_uniform(shd_mrt_deferred_lighting_dynamic_sprite_alpha_filter, "in_MetallicRoughness_UVs");
mrt_deferred_lighting_dynamic_sprite_alpha_filtered_shader_emissivemap_uv_index = shader_get_uniform(shd_mrt_deferred_lighting_dynamic_sprite_alpha_filter, "in_Emissive_UVs");
mrt_deferred_lighting_dynamic_sprite_alpha_filtered_shader_alphafiltermap_uv_index = shader_get_uniform(shd_mrt_deferred_lighting_dynamic_sprite_alpha_filter, "in_AlphaFilter_UVs");

mrt_deferred_lighting_dynamic_sprite_alpha_filtered_shader_vector_scale_index = shader_get_uniform(shd_mrt_deferred_lighting_dynamic_sprite_alpha_filter, "in_VectorScale");
mrt_deferred_lighting_dynamic_sprite_alpha_filtered_shader_vector_angle_index = shader_get_uniform(shd_mrt_deferred_lighting_dynamic_sprite_alpha_filter, "in_VectorAngle");

mrt_deferred_lighting_dynamic_sprite_alpha_filtered_shader_layer_depth_index = shader_get_uniform(shd_mrt_deferred_lighting_dynamic_sprite_alpha_filter, "in_Layer_Depth");

mrt_deferred_lighting_dynamic_sprite_alpha_filtered_shader_normal_strength_index = shader_get_uniform(shd_mrt_deferred_lighting_dynamic_sprite_alpha_filter, "in_NormalStrength");
mrt_deferred_lighting_dynamic_sprite_alpha_filtered_shader_metallic_index = shader_get_uniform(shd_mrt_deferred_lighting_dynamic_sprite_alpha_filter, "in_Metallic");
mrt_deferred_lighting_dynamic_sprite_alpha_filtered_shader_roughness_index = shader_get_uniform(shd_mrt_deferred_lighting_dynamic_sprite_alpha_filter, "in_Roughness");
mrt_deferred_lighting_dynamic_sprite_alpha_filtered_shader_emissive_index = shader_get_uniform(shd_mrt_deferred_lighting_dynamic_sprite_alpha_filter, "in_Emissive");
mrt_deferred_lighting_dynamic_sprite_alpha_filtered_shader_emissive_multiplier_index = shader_get_uniform(shd_mrt_deferred_lighting_dynamic_sprite_alpha_filter, "in_EmissiveMultiplier");

mrt_deferred_lighting_dynamic_sprite_alpha_filtered_shader_alpha_filter_index = shader_get_uniform(shd_mrt_deferred_lighting_dynamic_sprite_alpha_filter, "in_AlphaFilter");

mrt_deferred_lighting_dynamic_sprite_alpha_filtered_shader_normalmap_enabled_index = shader_get_uniform(shd_mrt_deferred_lighting_dynamic_sprite_alpha_filter, "in_NormalMap_Enabled");
mrt_deferred_lighting_dynamic_sprite_alpha_filtered_shader_metallicroughnessmap_enabled_index = shader_get_uniform(shd_mrt_deferred_lighting_dynamic_sprite_alpha_filter, "in_MetallicRoughnessMap_Enabled");
mrt_deferred_lighting_dynamic_sprite_alpha_filtered_shader_emissivemap_enabled_index = shader_get_uniform(shd_mrt_deferred_lighting_dynamic_sprite_alpha_filter, "in_EmissiveMap_Enabled");

mrt_deferred_lighting_dynamic_sprite_alpha_filtered_shader_normalmap_texture_index = shader_get_sampler_index(shd_mrt_deferred_lighting_dynamic_sprite_alpha_filter, "gm_NormalTexture");
mrt_deferred_lighting_dynamic_sprite_alpha_filtered_shader_metallicroughnessmap_texture_index = shader_get_sampler_index(shd_mrt_deferred_lighting_dynamic_sprite_alpha_filter, "gm_MetallicRoughnessTexture");
mrt_deferred_lighting_dynamic_sprite_alpha_filtered_shader_emissivemap_texture_index = shader_get_sampler_index(shd_mrt_deferred_lighting_dynamic_sprite_alpha_filter, "gm_EmissiveTexture");
mrt_deferred_lighting_dynamic_sprite_alpha_filtered_shader_alphafiltermap_texture_index = shader_get_sampler_index(shd_mrt_deferred_lighting_dynamic_sprite_alpha_filter, "gm_AlphaFilterTexture");

// MRT Deferred Lighting Dynamic Particle Shader Indexes
mrt_deferred_lighting_dynamic_particle_shader_camera_offset_index = shader_get_uniform(shd_mrt_deferred_lighting_particle_system, "in_Camera_Offset");

mrt_deferred_lighting_dynamic_particle_shader_layer_depth_index = shader_get_uniform(shd_mrt_deferred_lighting_particle_system, "in_Layer_Depth");

mrt_deferred_lighting_dynamic_particle_shader_metallic_index = shader_get_uniform(shd_mrt_deferred_lighting_particle_system, "in_Metallic");
mrt_deferred_lighting_dynamic_particle_shader_roughness_index = shader_get_uniform(shd_mrt_deferred_lighting_particle_system, "in_Roughness");
mrt_deferred_lighting_dynamic_particle_shader_emissive_index = shader_get_uniform(shd_mrt_deferred_lighting_particle_system, "in_Emissive");
mrt_deferred_lighting_dynamic_particle_shader_emissive_multiplier_index = shader_get_uniform(shd_mrt_deferred_lighting_particle_system, "in_EmissiveMultiplier");

// MRT Deferred Lighting Dynamic Smoke Trail Shader Indexes
mrt_deferred_lighting_dynamic_smoke_trail_shader_camera_offset_index = shader_get_uniform(shd_mrt_deferred_lighting_dynamic_smoke_trail, "in_Camera_Offset");

mrt_deferred_lighting_dynamic_smoke_trail_shader_layer_depth_index = shader_get_uniform(shd_mrt_deferred_lighting_dynamic_smoke_trail, "in_Layer_Depth");

mrt_deferred_lighting_dynamic_smoke_trail_shader_metallic_index = shader_get_uniform(shd_mrt_deferred_lighting_dynamic_smoke_trail, "in_Metallic");
mrt_deferred_lighting_dynamic_smoke_trail_shader_roughness_index = shader_get_uniform(shd_mrt_deferred_lighting_dynamic_smoke_trail, "in_Roughness");
mrt_deferred_lighting_dynamic_smoke_trail_shader_emissive_index = shader_get_uniform(shd_mrt_deferred_lighting_dynamic_smoke_trail, "in_Emissive");
