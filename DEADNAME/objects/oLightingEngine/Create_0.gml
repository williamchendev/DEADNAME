...
// MRT Deferred Lighting Dynamic Primitive Shader Indexes
mrt_deferred_lighting_dynamic_primitive_shader_camera_offset_index = shader_get_uniform(shd_mrt_deferred_lighting_dynamic_primitive, "in_Camera_Offset");

mrt_deferred_lighting_dynamic_primitive_shader_layer_depth_index = shader_get_uniform(shd_mrt_deferred_lighting_dynamic_primitive, "in_Layer_Depth");

mrt_deferred_lighting_dynamic_primitive_shader_metallic_index = shader_get_uniform(shd_mrt_deferred_lighting_dynamic_primitive, "in_Metallic");
mrt_deferred_lighting_dynamic_primitive_shader_roughness_index = shader_get_uniform(shd_mrt_deferred_lighting_dynamic_primitive, "in_Roughness");
mrt_deferred_lighting_dynamic_primitive_shader_emissive_index = shader_get_uniform(shd_mrt_deferred_lighting_dynamic_primitive, "in_Emissive");
mrt_deferred_lighting_dynamic_primitive_shader_emissive_multiplier_index = shader_get_uniform(shd_mrt_deferred_lighting_dynamic_primitive, "in_EmissiveMultiplier");
