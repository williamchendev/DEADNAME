...
{
	//draw_surface_ext(pbr_lighting_mid_color_surface, -render_border * GameManager.game_scale, -render_border * GameManager.game_scale, GameManager.game_scale, GameManager.game_scale, 0, c_white, 1);
