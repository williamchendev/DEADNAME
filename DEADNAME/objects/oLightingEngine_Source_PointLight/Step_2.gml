...
(
    x - point_light_falloff_radius, 
    y - point_light_falloff_radius, 
    x + point_light_falloff_radius, 
    y + point_light_falloff_radius, 
...
{
    //
    var temp_point_light_changed = (point_light_falloff_radius != old_point_light_falloff_radius) or (x != old_point_light_position_x) or (y != old_point_light_position_y);
    ...
    if (temp_point_light_changed)
    {
		...
		//
        collision_circle_list(x, y, point_light_falloff_radius, oSolid, false, false, point_light_collisions_list, false);
    }
    
    //
    old_point_light_falloff_radius = point_light_falloff_radius;
