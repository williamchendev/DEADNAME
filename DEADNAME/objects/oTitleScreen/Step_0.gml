...
if (play_active) 
{
	...
	play_fade_timer += play_fade_spd * frame_delta;
...
{
	deadname_title_alpha += frame_delta * deadname_title_alpha_spd;
...
if (deadname_title_alpha >= 0.8) 
{
	...
	{
		inno_spelman_text_alpha += frame_delta * inno_spelman_text_alpha_spd;
...
button_move_timer += title_button_move_spd * frame_delta;
