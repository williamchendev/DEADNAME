//
// Point Light and Spot Light Shadow vertex shader for Inno's Deferred Lighting System
//
...
// Uniform Light Source & Collider Properties
...
void main()
{
    ...
    if (in_Position.z != 0.0)
    {
        ...
        {
            // Light Source Position too close to Shadow Vertex - Disable Vertex
